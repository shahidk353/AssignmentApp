<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <x-nav-link :href="route('friend-requests.pending')" :active="request()->routeIs('friend-requests.pending')">
            {{ __('Friend Requests') }}
            @php
                $pendingRequestsCount = Auth::user()->receivedFriendRequests()->where('status', 'pending')->count();
            @endphp
